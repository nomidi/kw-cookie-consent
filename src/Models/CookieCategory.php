    ...
    class CookieCategory extends DataObject
    {
        ...
        public function getCMSFields()
        {
            ...
            $fields->addFieldsToTab('Root.Main', array(
                ...
                GridField::create(
                    'CookieEntries',
                    _t('CookieCategory.COOKIEENTRIES', "Cookies"),
                    $this->CookieEntries(),
                    GridFieldConfig_RecordEditor::create()
                )
            ));

            $fields->addFieldToTab('Root.Main', new \LiteralField('CookieCategoryID', '<br>CookieCategoryID: '.$this->CookieCategoryID));
        ...
        public function onBeforeWrite()
        {
            ...
            $this->CookieCategoryID = $filter->filter($this->Title);
        }
